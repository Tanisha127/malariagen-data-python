...
class AnophelesH12Analysis(
    ...
    def h12_gwss(
        ...
        random_seed: base_params.random_seed = 42,
        apply_hampel: h12_params.apply_hampel = h12_params.apply_hampel_default,
        hampel_window: h12_params.hampel_window = h12_params.hampel_window_default,
        hampel_t: h12_params.hampel_t = h12_params.hampel_t_default,
        chunks: base_params.chunks = base_params.native_chunks,
        inline_array: base_params.inline_array = base_params.inline_array_default,
